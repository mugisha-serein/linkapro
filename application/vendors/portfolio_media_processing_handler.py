...
from .portfolio_media_commands import MarkPortfolioMediaProcessingCommand
...
VendorCommandHandlers.mark_portfolio_media_processing = mark_portfolio_media_processing
