...
from interface.governance.models import MarketplaceProjectionOutbox
...
def test_deliver_upsert_marks_event_delivered(monkeypatch):
    ...
    calls = []
    monkeypatch.setattr(
        "interface.governance.marketplace_outbox.sync_vendor_payload_to_marketplace",
...
def test_failed_delivery_returns_event_to_pending(monkeypatch):
    ...
    monkeypatch.setattr("interface.governance.marketplace_outbox.delete_vendor_from_marketplace", fail)
...
def test_retry_task_picks_pending_due_event(monkeypatch):
    ...
    delivered = []
    monkeypatch.setattr(
        "interface.governance.marketplace_outbox.deliver_marketplace_projection_outbox_event",
