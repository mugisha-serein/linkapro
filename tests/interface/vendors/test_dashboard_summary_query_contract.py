...
from interface.vendors.views.analytics import (
...
def test_dashboard_summary_view_builds_actor_aware_query():
    ...
    with patch(
        "interface.vendors.views.analytics._get_current_vendor_profile",
        return_value=(profile, None),
    ), patch(
        "interface.vendors.views.analytics.get_query_handlers",
...
def test_security_actions_view_loads_recent_audit_actions_for_vendor():
    ...
    with patch(
        ...
        "interface.vendors.views.analytics.recent_security_actions",
