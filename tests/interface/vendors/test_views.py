...
from interface.vendors.models import Inquiry, PortfolioImage, ServicePackage, VerificationDocument, VendorProfile as DjangoProfile
...
clear_private_portfolio_preview_urls = importlib.import_module(
    "interface.vendors.migrations.0010_clear_portfolio_local_preview_urls"
