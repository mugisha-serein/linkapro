...
from interface.vendors.portfolio_recovery import (
...
def test_recovery_dry_run_classifies_without_mutating_or_queueing(monkeypatch):
    ...
    monkeypatch.setattr(
        "interface.vendors.portfolio_recovery.process_vendor_portfolio_media_task.delay",
...
def test_recovery_restores_secure_url_from_cloudinary_public_id(monkeypatch):
    ...
    monkeypatch.setattr(
        "interface.vendors.portfolio_recovery.CloudinaryAdapter.get_resource",
...
def test_recovery_uploads_existing_temp_file_to_cloudinary(monkeypatch):
    ...
    monkeypatch.setattr(
        "interface.vendors.portfolio_recovery.CloudinaryAdapter.upload_image",
