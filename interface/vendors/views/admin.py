...
from interface.governance.marketplace_outbox import enqueue_vendor_projection, enqueue_vendor_projection_by_id
from interface.vendors.approval_workflow import approve_pending_vendor_submission
from interface.vendors.models import VendorProfile


class VendorRejectionSerializer(drf_serializers.Serializer):
    reason = drf_serializers.CharField(min_length=3, max_length=2000)
