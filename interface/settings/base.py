...
from interface.common.redis_config import get_redis_url, redis_ssl_options, redis_uses_tls
...
INSTALLED_APPS = [
    ...
    "interface.events",
    "interface.vendors",
    "interface.documents.apps.DocumentsConfig",
    "interface.governance.apps.GovernanceConfig",
    "interface.payments",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "two_factor_enrollment": os.environ.get("TWO_FACTOR_ENROLLMENT_RATE", "5/min"),
        "email_verification_ip": os.environ.get("EMAIL_VERIFICATION_IP_RATE", "5/min"),
        "email_verification_email": os.environ.get("EMAIL_VERIFICATION_EMAIL_RATE", "3/hour"),
...
MFA_REPLAY_HMAC_KEY = os.environ.get("MFA_REPLAY_HMAC_KEY", "").strip()
LOGIN_FAILURE_LOCKOUT_THRESHOLD = int(os.environ.get("LOGIN_FAILURE_LOCKOUT_THRESHOLD", "8"))
LOGIN_FAILURE_OBSERVATION_WINDOW_SECONDS = int(os.environ.get("LOGIN_FAILURE_OBSERVATION_WINDOW_SECONDS", "900"))
